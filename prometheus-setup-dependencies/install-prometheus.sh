...
sudo cp /tmp/devops-fully-auto/prometheus-setup-dependencies/prometheus.yml /etc/prometheus/
sudo cp /tmp/devops-fully-auto/prometheus-setup-dependencies/prometheus.service /etc/systemd/system/prometheus.service
